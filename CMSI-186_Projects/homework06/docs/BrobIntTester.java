 ...
 *  1.1.0  2017-04-13  B.J. Johnson  addByteed new BrobInt instances to check addByteition; refactored to
 *                                     check the new versions of compareTo and equals; verified that all
 *                                     addByteitions work for both small and large numbers, as well as for
 *                                     values of different lengths and including same-sign negative value
 *                                     addByteitions; ready to start subtractByteByte and subtractByteInt methods
 *
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
public class BrobIntTester {
   ...
   public static void main( String[] args ) {
      ...
      try {
         System.out.println( "    Test 014: addByteing g11 and g12: " );
      ...
      try {
         System.out.println( "    Test 016: addByteing g11 and g13 [10 + 234567] using bytes: " );
         System.out.println( "      expecting: 234577 and got " + g11.addByte( g13 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 017: addByteing g11 and g13 [10 + 234567] using ints: " );
         System.out.println( "      expecting: 234577 and got " + g11.addByte( g13 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 018: addByteing g13 and g11 [234567 + 10] using bytes: " );
         System.out.println( "      expecting: 234577 and got " + g13.addByte( g11 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 019: addByteing g13 and g11 [234567 + 10] using ints: " );
         System.out.println( "      expecting: 234577 and got " + g13.addByte( g11 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "    Test 022: addByteing g14 and g15 [-234567 + -10] using bytes: " );
         System.out.println( "      expecting: -234577 and got " + g14.addByte( g15 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 023: addByteing g14 and g15 [-234567 + -10] using ints: " );
         System.out.println( "      expecting: -234577 and got " + g14.addByte( g15 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 024: addByteing g15 and g14 [-10 + -234567] using bytes: " );
         System.out.println( "      expecting: -234577 and got " + g15.addByte( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 025: addByteing g15 and g14 [-10 + -234567] using ints: " );
         System.out.println( "      expecting: -234577 and got " + g15.addByte( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
      ...
      try {
         System.out.println( "    Test 027: addByteing g14 and g16 [-234567 + -999999] using bytes: " );
         System.out.println( "      expecting: -1234566 and got " + g14.addByte( g16 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 028: addByteing g14 and g16 [-234567 + -999999] using ints: " );
         System.out.println( "      expecting: -1234566 and got " + g14.addByte( g16 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 029: addByteing g16 and g14 [-999999 + -234567] using bytes: " );
         System.out.println( "      expecting: -1234566 and got " + g16.addByte( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }

      try {
         System.out.println( "    Test 030: addByteing g16 and g14 [-999999 + -234567] using ints: " );
         System.out.println( "      expecting: -1234566 and got " + g16.addByte( g14 ) );
      }
      catch( Exception e ) { System.out.println( "        Exception thrown:  " ); }
