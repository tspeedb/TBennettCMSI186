...
public class Fibonacci {
   ...
   // public static final BrobInt zero = new BrobInt(Integer.toString(0));
   // public static final BrobInt one = new BrobInt(Integer.toString(1));


   public static BrobInt Fibonacci(int fibNum) {
       ...
       BrobInt num = new BrobInt("0");
       BrobInt prevNum = new BrobInt("1");

       for (int i = 0; i < fibNum - 1; i++){
           BrobInt var = num.addByte(prevNum);
           prevNum = num;
           num = var;
       }
       return num;
